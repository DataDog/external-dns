...
func waitForCacheSync(ctx context.Context, timeout time.Duration, factory informerFactory) error {
...
func waitForDynamicCacheSync(ctx context.Context, cacheSyncTimeout time.Duration, factory dynamicInformerFactory) error {
