...
var (
	...
	overriddenConfig = &Config{
		...
		CacheSyncTimeout:            20 * time.Minute,
		DynamicCacheSyncTimeout:     20 * time.Minute,
	...
	for _, ti := range []struct {
		...
		},
		{
			...
			args: []string{
				...
				"--cache-sync-timeout=20m",
				"--dynamic-cache-sync-timeout=20m",
				"--interval=10m",
		...
		},
		{
			...
			envVars: map[string]string{
				...
				"EXTERNAL_DNS_CACHE_SYNC_TIMEOUT":              "20m",
				"EXTERNAL_DNS_DYNAMIC_CACHE_SYNC_TIMEOUT":      "20m",
